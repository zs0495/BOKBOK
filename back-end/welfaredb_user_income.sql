...
CREATE TABLE `user_income` (
  ...
  PRIMARY KEY (`income_id`,`user_no`),
  KEY `user_no` (`user_no`),
  CONSTRAINT `user_income_ibfk_1` FOREIGN KEY (`income_id`) REFERENCES `income` (`income_id`),
  CONSTRAINT `user_income_ibfk_2` FOREIGN KEY (`user_no`) REFERENCES `personal_info` (`user_no`)
